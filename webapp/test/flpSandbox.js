		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Upload and Download",
									"targetURL": "#comuploadfioriupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comuploadfioriupload-display": {
								"semanticObject": "comuploadfioriupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.upload.fioriupload",
									"url": sap.ui.require.toUrl("com/upload/fioriupload")
								}
							}
						}
					}
